    ...
    setup(props, { emit }) {
      ...
      const formFields = reactive([
        ...
        },
        {
          ...
          cols: 3,
          defaultValue: props.customer.invoicingEmail,
        },
        {
          key: 'reminderEmail',
          type: 'string',
          ...
          cols: 3,
          defaultValue: props.customer.reminderEmail,
        },
        {
          key: 'accountStatementEmail',
          type: 'string',
          label: 'Account Statement Email',
          cols: 3,
          defaultValue: props.customer.accountStatementEmail,
        },
        {
          key: 'phone',
          type: 'string',
